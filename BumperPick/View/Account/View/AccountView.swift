...
struct AccountView: View {
    ...
    @EnvironmentObject var customerSession: CustomerSession // 👈 this is the fix
    ...
    var body: some View {
        ...
        .navigationDestination(isPresented: $navigateToCart) {
            CartView(isCart: false, isFavourite: false)
        }
        ...
        .navigationDestination(isPresented: $navigateToFaq) {
            FaqView()
        }
    ...
    private var supportTicket: some View {
        Button(action: {
